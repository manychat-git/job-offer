...
export const COMPANIES = [
  { value: "manychat_sl", label: "Manychat S.L." },
  { value: "manychat_inc", label: "Manychat Inc." },
  { value: "octohub_llc", label: "OctoHub LLC" }
];
  ...
  honduras: [
    {
      emoji: "🪴",
      title: "Remote work",
      description: "Work from the comfort of your home and enjoy paid business trips for in-person team meetings a few times a year."
    },
    {
      emoji: "🌴",
      title: "Generous leave options",
